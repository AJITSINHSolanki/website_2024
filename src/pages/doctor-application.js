...
import { Service11, Service2,ServiceDetails } from "../../public/images";
    ...
    return(
        ...
        <Layout>
            <div className="services_details_box">
                <p className="title">Doctor Applications</p>
                <p className="content">Comprehensive website and application tailored for doctors, facilitating efficient patient management, appointment scheduling, and seamless communication for enhanced medical practice.</p>
            </div>

            <div className="container">
                <div className="detail_s_box">
                    <img src={Service11.src} alt="Product and Web Development" />
                </div>
            </div>
