  ...
  return (
    ...
    <>
      ...
      <div className="services_details_box">
        ...
        <p className="content">
          Comprehensive website and application tailored for doctors,
          facilitating efficient patient management, appointment scheduling, and
          seamless communication for enhanced medical practice.
        </p>
      </div>
