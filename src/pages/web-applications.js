        ...
        <>
            ...
            <Layout>
                <div className="services_details_box">
                    <p className="title">Web Applications</p>
                    <p className="content">We create web applications with scalable architecture and engaging designs that deliver seamless user experiences.</p>
                </div>
