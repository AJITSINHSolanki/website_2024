...
import { Service10,ServiceDetails } from "../../public/images";
import ServicesSlider from "@/components/servicesSlider";
const PatientApplications = () => {
    return( 
        <>
        <Head>
            <title>Patient Applications</title>
        ...
        <Layout>
            <div className="services_details_box">
                <p className="title">Patient Applications</p>
                <p className="content">Seamless website and application for patients, providing easy access to medical information and appointment scheduling for enhanced healthcare experience.</p>
            </div>

            <div className="container">
                <div className="detail_s_box">
                    <img src={Service10.src} alt="Product and Web Development" />
                </div>
            </div>
