...
import {Service9,ServiceDetails } from "../../public/images";
          ...
          <Head>
            ...
            <Layout>
                <div className="services_details_box">
                    <p className="title">ERP Applications</p>
                    <p className="content">Healthcare ERP integrates inventory and invoice management, enhancing efficiency and organization in healthcare administration.</p>
                </div>
