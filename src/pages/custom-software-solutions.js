...
import { Service2,ServiceDetails } from "../../public/images";
...
const CustomSoftwareSolutions = () => {
    return (
        <>
            <Head>
                <title>Custom Software Solutions</title>
            ...
            <Layout>
                <div className="services_details_box">
                    <p className="title">Custom Software Solutions</p>
                    <p className="content">We provide custom software solutions for various industries with scalable architecture and efficient workflows.</p>
                </div>
