        ...
        <>
            ...
            <Layout>
                <div className="services_details_box">
                    <p className="title">Healthcare Apps</p>
                    <p className="content">We design and develop healthcare apps that deliver seamless user experiences and secure data management.</p>
                </div>
