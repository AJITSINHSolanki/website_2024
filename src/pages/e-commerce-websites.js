        ...
        <>
            ...
            <Layout>
                <div className="services_details_box">
                    <p className="title">E-commerce Websites</p>
                    <p className="content">We design and develop e-commerce websites with secure payment gateway integrations and user-friendly interfaces.</p>
                </div>
