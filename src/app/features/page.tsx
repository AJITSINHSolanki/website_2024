...
export const metadata: Metadata = {
  title:
    "ERP Applications for Healthcare IT Solutions, Healthcare software solutions in Ahmedabad, Gujarat, India",
  description:
...
const Features = () => {
  ...
  const FEATURES = [
    ...
    },
    {
      ...
      image: inventory_file,
      images: inventory_report,
      items: [
        "Sales Report",
        "Purchase Report",
        "User-Friendly Dashboard",
    ...
    <div className="w-full px-4 sm:px-side min-h-screen py-8">
      <div className="">
        ...
        <p className="text-xl sm:text-2xl mt-10 text-center">
          Experience the power of an all-in-one ERP designed to optimize patient
          care,
          ...
          {WHY_CHOOSE_US_CARDS.map((feature, index) => (
            ...
            >
              ...
              <div className="w-3/5 px-2 space-y-4">
                ...
                <p className="text-lg sm:text-xl">{feature.description}</p>
              </div>
            </div>
          ))}
        </div>
