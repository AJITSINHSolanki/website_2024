      ...
      <div className="container">
        ...
        <div class="featureContainer">
          <div class="box-container">
            ...
            <div class="box-text">Inventory Management & Tracking</div>
          </div>
          <div class="box-container">
            <div class="box"><span>
                  <svg
            ...
            <div class="box-text">Tax and Quick Bill Management System</div>
          </div>
          <div class="box-container">
            <div class="box"><span>
                  <svg
            ...
            <div class="box-text">Analytics Report</div>
          </div>
          <div class="box-container">
            <div class="box"><span>
                  <svg
            ...
            <div class="box-text">Centralized Database</div>
          </div>
          <div class="box-container">
            <div class="box"><span>
                  <svg
            ...
            <div class="box-text">Cloud Based Management</div>
          </div>
