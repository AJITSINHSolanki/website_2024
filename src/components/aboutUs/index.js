          ...
          <div className="ceo_section">
            ...
            <div className="ceo_content">
              <p>
                <q>
                  {" "}
                  &nbsp; &nbsp; &nbsp; &nbsp;Every business that serves
                  customers has the challenge or goal to make their life better.
                  My Algo Soft <span>helps with edge cases</span> by using
                  intent from behavior data to better help with the problems
                  they came to solve. by using intent from behavior data to
                  better help with the problems they came to solve.
                </q>
              </p>
