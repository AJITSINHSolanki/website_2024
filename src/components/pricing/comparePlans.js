import { ComparePlansInfo } from "@/utils/constant";
    ...
    return (
        <div className="container">
            <div className="custio-feature-grid">
                <p className="main_title">Compare <span>Plans</span>
                        ...
                        <div key={key} className="feature-grid__label_item">
                            ...
                            <div className="feature-grid__col_2">
                                <div className="feature_text">
                                    {item.stapeOne === true ? <Image src={PRightImg} alt="close" />
                                        : <Image src={PCloseImg} alt="right" />}
                                </div>
                                <div className="feature_text">
                                    {item.stapeTwo === true ? <Image src={PRightImg} alt="close" />
                                        : <Image src={PCloseImg} alt="right" />}
                                </div>
                            </div>
                        </div>
